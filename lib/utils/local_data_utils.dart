...
class LocalDataUtils {
  ...
  static Future<bool> setMap(String key, Map value) async => (await _prefs).setString(key, json.encode(value));

  static Future<Map<String, dynamic>?> getMap(String key) async => (await _prefs).getString(key)?.toMap();
